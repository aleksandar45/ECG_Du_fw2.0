...
#ifndef __GY_ACC_FUNCTIONS_H
#define __GY_ACC_FUNCTIONS_H
...
//=========ECG error numbers=====//
#define GYACC_INIT1_ERROR 					1
#define GYACC_INIT2_ERROR						2
#define GYACC_READ_DATA1_ERROR 			3
#define GYACC_READ_DATA2_ERROR			4
#define GYACC_MISS_DATA_OVF_ERROR		5
//=========ECG error numbers=====//

// Types ------------------------------------------------------------------//
typedef enum {
	GYACC_OK = 0,					//GYACC perifery is ok
	GYACC_ERROR = 1,			//GYACC perifery is not ok
}GYACC_StatusTypeDef;

typedef struct
{	
			I2C_HandleTypeDef* i2cHandle;									//I2C periphery connected to GYACC module.		
			...
			GYACC_StatusTypeDef gyAccStatus;							//GYACC module status.
			uint8_t ErrorNumber;													//GYACC error number.												
